...
def get_equipment(request):
    ...
    #     model = "Pistola Glock",
    #     caliber = ".44",
    #     # Recupera o caminho estático e soma com o da imagem
    #     image_path = "img/colete_balistico.png"
    # ).save()
    # models.Equipment(
    #     serial_number = '165161',
    #     uid = "123",
    #     type = 'armament',
    #     observation = 'models.TextField(, default=None)',
    #     armament = models.Model_armament.objects.get(model="Pistola Glock")
    # ).save()
...
def get_models_equipment(request):
    ...
    types = {"Granada": {"name" : "Granada", "eng_name": "Granade", "models": grenada_models},
            "Munição": {"name" : "Munição", "eng_name": "Bullet", "models": bullet_models},
            "Acessório": {"name" : "Acessorio", "eng_name": "Acessory", "models": accessory_models},
            "Vestível": {"name" : "Vestível", "eng_name": "Wearble", "models": wearbles_models}, 
            "Armamento": {"name" : "Armamento", "eng_name": "Armament", "models": armament_models},
            }
