...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(default='Bullet', max_length=50, verbose_name='Tipo')),
        ...
        migrations.AddField(
            model_name='equipment',
            name='status',
            field=models.CharField(default='Disponível', max_length=10, verbose_name='Estado atual'),
        ),
        ...
        migrations.AlterField(
            model_name='equipment',
            name='type',
            field=models.CharField(default='Bullet', max_length=50, verbose_name='Tipo'),
        ),
        migrations.AlterField(
            model_name='equipment',
            name='type_id',
        ...
        migrations.AlterField(
            model_name='equipment',
            name='uid',
            field=models.CharField(max_length=20, primary_key=True, serialize=False, verbose_name='UID'),
        ),
    ]
